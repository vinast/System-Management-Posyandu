...
{
    out << endl;
    out << "Berikut Tampilan Data Vaksin Posyandu Bahagia..." << endl;
    for (int i = 0; i < x.size - 1; i++)
    {
        // out << "Data barang ke-" <<  i + 1 << endl;
        out << "----------------------------------------------" << endl;
        out << "ID Vaksin     : " << x.element[i].id;
        out << endl;
        out << "nama Vaksin   : " << x.element[i].nama;
        out << endl;
        out << "stok Vaksin   : " << x.element[i].stok;
        out << endl;
        out << "harga Vaksin  : " << x.element[i].harga;
        out << endl;
        out << "----------------------------------------------" << endl;
    }
    return out;
