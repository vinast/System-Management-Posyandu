...
ostream &operator<<(ostream &out, const DinamisBalita<T> &x)
{
    ...
    for (int i = 0; i < x.size-1; i++)
    {
        ...
        out<<"----------------------------------------------"<<endl;
        out << "No rekam medis      : " << x.element[i].norekam;
        out << endl;
        out << "NAMA                : " << x.element[i].namaBalita;
        out << endl;
        out << "IBU                 : " << x.element[i].ibu;
        out << endl;
        out << "Tinggi              : " << x.element[i].tinggi;
        out << endl;
        out << "Berat               : " << x.element[i].berat;
        out << endl;
        out << "Umur                : " << x.element[i].umur;
        out << endl;
        out<<"----------------------------------------------"<<endl;
    }
    return out;
